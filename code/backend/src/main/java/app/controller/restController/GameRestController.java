...
public class GameRestController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Found the games", content = {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Found the games by name or category", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = Game.class)) }),
                        @ApiResponse(responseCode = "404", description = "Games not found", content = @Content) })
        @GetMapping("/search")
        ...
        public Page<Game> getMoreFoundGames(@Parameter(description = "page of games") @PathVariable int page,
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Found the game", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = GameDetails.class)) }),
                        @ApiResponse(responseCode = "404", description = "Game not found", content = @Content),
                        @ApiResponse(responseCode = "403", description = "forbiden o dont have permissions", content = @Content) })

        @GetMapping("/{id}")
        public ResponseEntity<GameDetails> gameDetails(
                ...
                if (opGame.isPresent()) {
                        ...
                        GameDetails gameDetails = new GameDetails(game,
                                        reviewService.findByGame(game, PageRequest.of(0, 6)));
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Game deleted", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = Game.class)) }),
                        @ApiResponse(responseCode = "404", description = "Game not found", content = @Content) })
        // Delete a game
        @DeleteMapping("/{id}")
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Game edited", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = Game.class)) }),
                        @ApiResponse(responseCode = "404", description = "Game not found", content = @Content) })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Found the cover image", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = Game.class)) }),
        ...
        public ResponseEntity<Resource> downloadImageProfile(
                        @Parameter(description = "id of the game") @PathVariable long id) throws SQLException {
                return gameService.downloadImageProfile(id);
        }

        @Operation(summary = "Get the gameplay images of a game")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Found the gameplay images", content = {
                                        @Content(mediaType = "application/json", schema = @Schema(implementation = Game.class)) }),
                        @ApiResponse(responseCode = "404", description = "Gameplay images not found", content = @Content) })
        @GetMapping("/{id}/gameplayImage/{index}")
        public ResponseEntity<Resource> downloadGameplayImages(
                        @Parameter(description = "id of the game") @PathVariable long id,
                        @Parameter(description = "index of the gameplay image") @PathVariable int index)
                        throws SQLException {
